...
- **2 — Resectable with low to medium risk**  
...
- **3 — Resectable with medium to high risk**  
...
## User Workflow
In the sidebar menu on the left, you will find the **Workflow** tab. This is where you access the interface used to annotate and score the template brain. The annotation workflow follows a simple, iterative process that consists of three main steps:

##### 1. Select a Brain Region of Interest
You can define regions of interest using a combination of tools:

- **Atlas-based selection**, based on the Desikan-Killiany, Destrieux, or fiber tract segmentations
- **Interactive region-clicking**, allowing quick selection of predefined anatomical areas
- **Manual painting** on 2D MRI slices with automatic propagation into the 3D brain volume
...
Guided by the macroanatomical structure of the brain — available via the selection bar at the top of the interface — you can proceed step by step until every voxel of the template MRI has been assigned a resectability score. You can monitor your progress in the Progress tab, where you can also save your current annotations for later completion or final submission. Once you have completed at least 75% of the brain, you can use the Remaining tab to identify regions that still need to be scored. This allows you to efficiently review and assign scores to the remaining tissue—without the need to manually search for areas that were overlooked, whether intentionally or unintentionally.

## Saving Progress & Finalization 
At any time, you can save your current progress by clicking **Save** in the *Progress* tab. This will download a file with the `.rds` extension, which you can store on your device.  
The next time you log in, simply use the **Browse** option to upload your saved file and resume where you left off.
...
Once you have scored 95% you can finalize your output in the Progress tab. This downloads your progress to a file you can upload [here]().
